...
RELEASE_NAME = "dxlvtapiclient-python-dist-" + str(VERSION)
...
subprocess.check_call(["sphinx-apidoc",
                       ...
                       os.path.join(DIST_PY_FILE_LOCATION, "dxlvtapiclient")])
...
print("\nRemoving dxlvtapiclient.egg-info\n")
remove_tree(os.path.join(DIST_PY_FILE_LOCATION, "dxlvtapiclient.egg-info"))
